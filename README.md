...
To ensure scalable tracking, automated integration, and seamless deployment, this project utilizes a complete MLOps pipeline described below:

```mermaid
graph LR
    A[Google Colab + MLflow] -->|Register Best Model| B[Hugging Face Hub]
    B -->|Trigger Webhook / Update Code| C[GitHub Actions CI/CD]
    C -->|Build Docker Image| D[Google Artifact Registry]
    D -->|Deploy Container| E[Google Cloud Run + FastAPI]
```
...
![Succes Response](images/response_success.png)
